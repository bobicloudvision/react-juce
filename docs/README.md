...
Yes, please! I would be very happy to welcome your involvement. Take a look at the [open issues](https://github.com/bobicloudvision/react-juce/issues)
or the [project tracker](https://github.com/bobicloudvision/react-juce/projects/1) to see if there's outstanding work that you might
be able to get started. Or feel free to propose an idea or offer feedback by [opening an issue](https://github.com/bobicloudvision/react-juce/issues/new) as well.
