...
**TODO**: Document props. See [the class](https://github.com/bobicloudvision/react-juce/blob/master/packages/react-juce/src/components/TextInput.tsx#L11) for props in the meantime.
