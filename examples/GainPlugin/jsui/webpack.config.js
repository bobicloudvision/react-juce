...
module.exports = (env, argv) => {
  ...
  return {
    ...
    output: {
      ...
      // Duktape 2.4 (react-juce) — webpack 5.48 only documents these flags.
      environment: {
        arrowFunction: false,
        bigIntLiteral: false,
        const: false,
    ...
    resolve: {
      ...
      // Prefer CJS entry points so the bundle does not mix ESM runtime with
      // CommonJS (Duktape throws: "ES Modules may not assign module.exports").
